...
// Validate ../../../src/app/api/products/auth/login/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/auth/login">> = Specific
  const handler = {} as typeof import("../../../src/app/api/products/auth/login/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/products/auth/register/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/auth/register">> = Specific
  const handler = {} as typeof import("../../../src/app/api/products/auth/register/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
