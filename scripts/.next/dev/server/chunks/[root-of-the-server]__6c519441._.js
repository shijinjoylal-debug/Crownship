...
const productsFile = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, 'products.json');
const usersFile = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, 'users.json');
...
const db = {
    products: {
        getAll: ()=>readJSON(productsFile),
        getById: (id)=>readJSON(productsFile).find((p)=>p.id === id)
    },
    users: {
        findByEmail: (email)=>readJSON(usersFile).find((u)=>u.email === email),
        create: (user)=>{
...
;
async function GET() {
    const products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].products.getAll();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c519441._.js.map